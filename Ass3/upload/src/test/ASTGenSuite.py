...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_simple_program6(self):
        ...
        expect = str(Program([ClassDecl(Id("Shape"),[AttributeDecl(Instance(),VarDecl(Id("my1stVar"),IntType())),AttributeDecl(Instance(),VarDecl(Id("myArrayVar"),ArrayType(IntLiteral(5),IntType()))),AttributeDecl(Static(),VarDecl(Id("my2ndVar"),ClassType("Shape"))),AttributeDecl(Static(),VarDecl(Id("my3rdVar"),ClassType("Shape"))),AttributeDecl(Static(),VarDecl(Id("my2ndArray"),ArrayType(IntLiteral(6),ClassType("Shape")))),AttributeDecl(Static(),VarDecl(Id("my3rdArray"),ArrayType(IntLiteral(6),ClassType("Shape"))))])]))
    ...
    def test_simple_program16(self):
        ...
        expect = str(Program([ClassDecl(Id("abc"),[MethodDecl(Static(),Id("getArea"),[VarDecl(Id("length"),FloatType()),VarDecl(Id("width"),FloatType())],VoidType(),Block([],[Assign(FieldAccess(SelfLiteral(),Id("aPI")),FloatLiteral(3.14)),Assign(Id("value"),CallExpr(Id("x"),Id("foo"),[IntLiteral(5)])),Assign(ArrayType(IntLiteral(3),ClassType("l")),BinaryOp("*",Id("value"),IntLiteral(2)))]))])]))    
    ...
    def test_simple_program17(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Static,List(VarDecl(Id(length),FloatType),VarDecl(Id(width),FloatType)),VoidType,Block(List(),List(If(BinaryOp(>,Id(a),IntLiteral(1)),CallStmt(Id(io),Id(write),[StringLiteral(\"Suy nua thi\")]),CallStmt(Id(io),Id(write),[StringLiteral(\"Anh sai roi\")])))))))))"
    ...
    def test_simple_program18(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Static,List(VarDecl(Id(length),FloatType),VarDecl(Id(width),FloatType)),VoidType,Block(List(),List(If(BinaryOp(==,Id(a),IntLiteral(1)),CallStmt(Id(io),Id(write),[StringLiteral(\"Suy nua thi\")])),If(BinaryOp(<,Id(b),IntLiteral(0)),AssignStmt(Id(b),BinaryOp(+,Id(c),IntLiteral(3))),AssignStmt(ArrayType(IntLiteral(1),ClassType(b)),Id(a))))))))))"    
    ...
    def test_simple_program19(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Static,List(VarDecl(Id(length),FloatType),VarDecl(Id(width),FloatType)),VoidType,Block(List(),List(If(BinaryOp(<=,Id(a),BinaryOp(+,Id(b),Id(c))),AssignStmt(Id(value),CallExpr(Id(x),Id(foo),List(IntLiteral(5))))),AssignStmt(ArrayType(IntLiteral(3),ClassType(l)),BinaryOp(*,Id(value),IntLiteral(2))),CallStmt(Id(io),Id(write),[StringLiteral(\"Suy nua thi\")]),If(BinaryOp(<,Id(b),IntLiteral(0)),AssignStmt(Id(b),BinaryOp(+,Id(c),IntLiteral(3))),AssignStmt(ArrayType(IntLiteral(1),ClassType(b)),Id(a))))))))))"    
    ...
    def test_simple_program20(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Static,List(VarDecl(Id(length),FloatType),VarDecl(Id(width),FloatType)),VoidType,Block(List(),List(If(BinaryOp(==,ArrayCell(Id(a),IntLiteral(3)),IntLiteral(1)),CallStmt(Id(io),Id(write),[StringLiteral(\"Suy nua thi\")])),If(BinaryOp(<,Id(b),IntLiteral(0)),AssignStmt(Id(b),BinaryOp(+,Id(c),IntLiteral(3))),AssignStmt(ArrayType(IntLiteral(1),ClassType(b)),Id(a))),CallStmt(Id(io),Id(write),[StringLiteral(\"Phia sau mot co gai\")]))))))))"
    ...
    def test_simple_program29(self):
        ...
        expect = str(Program([ClassDecl(Id("abc"),[MethodDecl(Static(),Id("getArea"),[VarDecl(Id("length"),FloatType()),VarDecl(Id("width"),FloatType())],IntType(),Block([],[For(Id("x"),IntLiteral(5),IntLiteral(2),False,CallStmt(Id("io"),Id("writeIntLn"),[Id("x")])),For(Id("i"),IntLiteral(1),IntLiteral(100),True,Block([],[CallStmt(Id("io"),Id("writeIntLn"),[Id("i")]),Assign(ArrayType(Id("i"),ClassType("Intarray")),BinaryOp("+",Id("i"),IntLiteral(1)))])),Return(CallExpr(Id("a"),Id("getNumber"),[IntLiteral(10)]))]))])]))    
    ...
    def test_simple_program31(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(Mouse),Instance,List(VarDecl(Id(a),IntType),VarDecl(Id(b),IntType)),IntType,Block(List(),List(CallStmt(Id(b),Id(getMax),[StringLiteral(\"anhmuonemsongsao\")]),Return(IntLiteral(0)))))))))"
    ...
    def test_simple_program32(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(Mouse),Instance,List(VarDecl(Id(a),IntType),VarDecl(Id(b),IntType)),IntType,Block(List(),List(CallStmt(Id(b),Id(getMax),[StringLiteral(\"anhmuonemsongsao\"),BinaryOp(+,Id(a),BinaryOp(/,Id(b),IntLiteral(10)))]),Return(IntLiteral(0)))))))))"  
    ...
    def test_simple_program33(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(Mouse),Instance,List(VarDecl(Id(a),IntType),VarDecl(Id(b),IntType)),IntType,Block(List(),List(CallStmt(Id(b),Id(getMax),[StringLiteral(\"nobody\"),StringLiteral(\"anhmuonemsongsao\")]),Return(IntLiteral(0)))))))))"    
    ...
    def test_simple_program34(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(Mouse),Instance,List(VarDecl(Id(a),IntType),VarDecl(Id(b),IntType)),IntType,Block(List(),List(CallStmt(Id(b),Id(getMax),[StringLiteral(\"anhmuonemsongsao\"),StringLiteral(\"kietlac\"),BinaryOp(%,Id(a),IntLiteral(10))]),Return(IntLiteral(0)))))))))"   
    ...
    def test_simple_program35(self):
        ...
        expect = str(Program([ClassDecl(Id("abc"),[MethodDecl(Instance(),Id("Mouse"),[VarDecl(Id("a"),IntType()),VarDecl(Id("b"),IntType())],IntType(),Block([],[CallStmt(Id("b"),Id("getMax"),[CallExpr(Id("c"),Id("giet"),[]),IntLiteral(10)]),Return(IntLiteral(0))]))])]))   
    ...
    def test_simple_program37(self):
        ...
        expect = str(Program([ClassDecl(Id("abc"),[MethodDecl(Instance(),Id("Mouse"),[VarDecl(Id("a"),IntType()),VarDecl(Id("b"),IntType())],IntType(),Block([],[CallStmt(Id("b"),Id("getMax"),[CallExpr(Id("c"),Id("getT"),[Id("e"),Id("a")])]),Return(IntLiteral(0))]))])]))   
    ...
    def test_simple_program38(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(Mouse),Instance,List(VarDecl(Id(a),IntType),VarDecl(Id(b),IntType)),IntType,Block(List(),List(CallStmt(Id(b),Id(getMax),[StringLiteral(\"e\"),BinaryOp(/,BinaryOp(*,Id(a),IntLiteral(10)),Id(b))]),Return(FieldAccess(SelfLiteral(),Id(t))))))))))"  
    ...
    def test_simple_program39(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(Cat),Instance,List(VarDecl(Id(a),IntType),VarDecl(Id(b),IntType)),IntType,Block(List(),List(CallStmt(Id(b),Id(getMax),[CallExpr(Id(Cat),Id(e),List()),StringLiteral(\"anh\")]),Return(IntLiteral(0)))))))))"   
    ...
    def test_simple_program42(self):
        ...
        expect = str(Program([ClassDecl(Id("abc"),[MethodDecl(Instance(),Id("Dog"),[VarDecl(Id("a"),IntType()),VarDecl(Id("b"),IntType())],IntType(),Block([],[CallStmt(Id("b"),Id("getMax"),[CallExpr(Id("Cat"),Id("getName"),[]),CallExpr(Id("Mouse"),Id("getName"),[])]),Return(IntLiteral(0))]))])]))   
    ...
    def test_simple_program44(self):
        ...
        expect = str(Program([ClassDecl(Id("Example1"),[MethodDecl(Instance(),Id("factorial"),[VarDecl(Id("n"),IntType())],IntType(),Block([],[If(BinaryOp("==",Id("n"),IntLiteral(0)),Return(IntLiteral(1)),Return(BinaryOp("*",Id("n"),CallExpr(SelfLiteral(),Id("factorial"),[BinaryOp("-",Id("n"),IntLiteral(1))]))))])),MethodDecl(Instance(),Id("main"),[],VoidType(),Block([AttributeDecl(Instance(),VarDecl(Id("x"),IntType()))],[Assign(Id("x"),CallExpr(Id("io"),Id("readInt"),[])),CallStmt(Id("io"),Id("writeIntLn"),[CallExpr(SelfLiteral(),Id("factorial"),[Id("x")])])]))])]))
    ...
    def test_simple_program45(self):
        ...
        expect = "Program(List(ClassDecl(Id(Example1),List(MethodDecl(Id(factorial),Instance,List(VarDecl(Id(n),IntType)),IntType,Block(List(),List(If(BinaryOp(==,Id(n),IntLiteral(0)),Return(IntLiteral(1)),Return(BinaryOp(*,Id(n),CallExpr(SelfLiteral(),Id(factorial),List(BinaryOp(-,Id(n),IntLiteral(1)))))))))),MethodDecl(Id(main),Instance,List(),VoidType,Block(List(AttributeDecl(Instance,VarDecl(Id(x),IntType))),List(AssignStmt(Id(x),CallExpr(Id(io),Id(read),List(StringLiteral(\"Nhap vao\")))),AssignStmt(Id(x),CallExpr(Id(io),Id(readInt),List())),CallStmt(Id(io),Id(writeIntLn),[CallExpr(SelfLiteral(),Id(factorial),List(Id(x)))]))))))))"
    ...
    def test_simple_program46(self):
        ...
        expect = str(Program([ClassDecl(Id("Example1"),[MethodDecl(Instance(),Id("factorial"),[VarDecl(Id("n"),IntType())],IntType(),Block([],[If(BinaryOp("==",Id("n"),IntLiteral(0)),Return(IntLiteral(1)),Return(BinaryOp("*",Id("n"),CallExpr(SelfLiteral(),Id("factorial"),[BinaryOp("-",Id("n"),IntLiteral(1))])))),Break()]))])]))
    ...
    def test_simple_program47(self):
        ...
        expect = str(Program([ClassDecl(Id("Example1"),[MethodDecl(Instance(),Id("factorial"),[VarDecl(Id("n"),IntType())],IntType(),Block([],[If(BinaryOp("==",BinaryOp("*",Id("n"),FloatLiteral(0.16)),IntLiteral(0)),Return(IntLiteral(1)),Return(BinaryOp("*",Id("n"),CallExpr(SelfLiteral(),Id("factorial"),[BinaryOp("-",Id("n"),IntLiteral(1))])))),Break()]))])]))
    ...
    def test_simple_program51(self):
        ...
        expect = str(Program([ClassDecl(Id("abc"),[MethodDecl(Static(),Id("getArea"),[VarDecl(Id("length"),FloatType()),VarDecl(Id("width"),FloatType())],StringType(),Block([],[For(Id("x"),BinaryOp("+",IntLiteral(5),CallExpr(Id("a"),Id("getT"),[])),IntLiteral(2),False,CallStmt(Id("io"),Id("writeIntLn"),[Id("x")])),For(Id("i"),BinaryOp("-",IntLiteral(1),CallExpr(Id("b"),Id("getN"),[])),IntLiteral(100),True,Block([],[CallStmt(Id("io"),Id("writeIntLn"),[Id("i")]),Assign(ArrayType(Id("i"),ClassType("Intarray")),BinaryOp("+",Id("i"),IntLiteral(1)))])),Return(FieldAccess(SelfLiteral(),Id("a")))]))])]))    
    ...
    def test_simple_program52(self):
        ...
        expect = str(Program([ClassDecl(Id("abc"),[MethodDecl(Static(),Id("getArea"),[VarDecl(Id("length"),FloatType()),VarDecl(Id("width"),FloatType())],StringType(),Block([],[For(Id("x"),BinaryOp("*",IntLiteral(5),CallExpr(Id("ee"),Id("g"),[Id("a"),Id("b")])),IntLiteral(2),False,CallStmt(Id("io"),Id("writeIntLn"),[Id("x")])),For(Id("i"),IntLiteral(1),IntLiteral(100),True,Block([],[CallStmt(Id("io"),Id("writeIntLn"),[Id("i")]),Assign(ArrayType(Id("i"),ClassType("Intarray")),BinaryOp("+",Id("i"),IntLiteral(1)))])),Return(FieldAccess(SelfLiteral(),Id("a")))]))])]))    
    ...
    def test_simple_program58(self):
        ...
        expect = "Program(List(ClassDecl(Id(Example1),List(MethodDecl(Id(factorial),Instance,List(VarDecl(Id(n),IntType)),IntType,Block(List(),List(If(BinaryOp(<,BinaryOp(==,BinaryOp(*,Id(n),FloatLiteral(0.16)),BinaryOp(||,IntLiteral(0),Id(a))),BinaryOp(+,Id(b),IntLiteral(34))),Return(IntLiteral(1)),Return(BinaryOp(*,Id(n),CallExpr(SelfLiteral(),Id(factorial),List(BinaryOp(-,Id(n),IntLiteral(1)),StringLiteral(\"bae\")))))),Break)))))))"
    ...
    def test_simple_program60(self):
        ...
        expect = "Program(List(ClassDecl(Id(Example1),List(MethodDecl(Id(factorial),Instance,List(VarDecl(Id(n),IntType)),IntType,Block(List(),List(If(BinaryOp(==,BinaryOp(*,Id(n),FloatLiteral(0.16)),IntLiteral(0)),Return(IntLiteral(1)),Return(BinaryOp(*,CallExpr(Id(n),Id(get),List(StringLiteral(\"hahahh\"))),CallExpr(SelfLiteral(),Id(factorial),List(BinaryOp(-,Id(n),IntLiteral(1))))))),Break)))))))"
    ...
    def test_simple_program64(self):
        ...
        expect = str(Program([ClassDecl(Id("abc"),[MethodDecl(Static(),Id("getArea"),[VarDecl(Id("length"),FloatType()),VarDecl(Id("width"),FloatType())],VoidType(),Block([],[Block([],[Assign(FieldAccess(SelfLiteral(),Id("length")),Id("length")),Assign(FieldAccess(SelfLiteral(),Id("length")),UnaryOp("!",Id("length"))),Assign(Id("a"),BinaryOp("+",Id("a"),BinaryOp("+",Id("a"),CallExpr(Id("Mouse"),Id("get"),[])))),Return(Id("a"))])]))])]))    
    ...
    def test_simple_program66(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Instance,List(VarDecl(Id(a),StringType),VarDecl(Id(b),StringType),VarDecl(Id(c),StringType),VarDecl(Id(d),StringType)),VoidType,Block(List(),List(Block(List(),List(AssignStmt(FieldAccess(SelfLiteral(),Id(length)),Id(length)),AssignStmt(FieldAccess(SelfLiteral(),Id(length)),UnaryOp(!,Id(length))),AssignStmt(Id(a),BinaryOp(+,Id(a),BinaryOp(+,Id(a),BinaryOp(%,Id(b),IntLiteral(10))))),If(BinaryOp(==,Id(a),Id(b)),CallStmt(Id(io),Id(write),[StringLiteral(\"ABC\")])),Return(Id(a)))))))))))"    
    ...
    def test_simple_program67(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Instance,List(VarDecl(Id(a),StringType),VarDecl(Id(b),StringType),VarDecl(Id(c),StringType),VarDecl(Id(d),StringType)),VoidType,Block(List(),List(Block(List(),List(AssignStmt(FieldAccess(SelfLiteral(),Id(length)),UnaryOp(-,Id(length))),AssignStmt(FieldAccess(SelfLiteral(),Id(length)),UnaryOp(!,Id(length))),AssignStmt(Id(a),BinaryOp(+,Id(a),BinaryOp(+,Id(a),BinaryOp(%,Id(b),IntLiteral(10))))),If(BinaryOp(==,Id(a),Id(b)),CallStmt(Id(io),Id(write),[StringLiteral(\"ABC\")])),Return(Id(a)))))))))))"    
    ...
    def test_simple_program68(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Instance,List(VarDecl(Id(a),StringType),VarDecl(Id(b),StringType),VarDecl(Id(c),StringType),VarDecl(Id(d),StringType)),VoidType,Block(List(),List(Block(List(),List(AssignStmt(FieldAccess(SelfLiteral(),Id(length)),Id(length)),AssignStmt(FieldAccess(SelfLiteral(),Id(length)),UnaryOp(!,Id(length))),AssignStmt(Id(a),BinaryOp(+,Id(a),BinaryOp(+,Id(a),BinaryOp(%,Id(b),IntLiteral(10))))),If(BinaryOp(==,Id(a),Id(b)),CallStmt(Id(io),Id(write),[StringLiteral(\"ABC\")]),CallStmt(Id(io),Id(read),[])),Return(BinaryOp(-,BinaryOp(*,BinaryOp(*,Id(a),Id(a)),Id(b)),IntLiteral(5))))))))))))"    
    ...
    def test_simple_program69(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Instance,List(VarDecl(Id(a),StringType),VarDecl(Id(b),StringType),VarDecl(Id(c),StringType),VarDecl(Id(d),StringType)),VoidType,Block(List(),List(Block(List(),List(AssignStmt(FieldAccess(SelfLiteral(),Id(length)),Id(length)),AssignStmt(FieldAccess(SelfLiteral(),Id(length)),UnaryOp(!,Id(length))),AssignStmt(Id(a),BinaryOp(+,Id(a),BinaryOp(+,Id(a),BinaryOp(%,Id(b),IntLiteral(10))))),If(BinaryOp(==,Id(a),Id(b)),CallStmt(Id(io),Id(write),[StringLiteral(\"ABC\")])),For(Id(a),BinaryOp(*,IntLiteral(1),CallExpr(Id(b),Id(get),List(StringLiteral(\"length\")))),IntLiteral(100),True,AssignStmt(Id(tong),BinaryOp(+,Id(tong),IntLiteral(1)))]),Return(Id(tong)))))))))))"    
    ...
    def test_simple_program70(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Instance,List(VarDecl(Id(a),StringType),VarDecl(Id(b),StringType),VarDecl(Id(c),StringType),VarDecl(Id(d),StringType)),VoidType,Block(List(),List(Block(List(),List(AssignStmt(FieldAccess(SelfLiteral(),Id(length)),Id(length)),AssignStmt(FieldAccess(SelfLiteral(),Id(length)),UnaryOp(!,Id(length))),AssignStmt(Id(a),BinaryOp(+,Id(a),BinaryOp(+,Id(a),BinaryOp(%,Id(b),IntLiteral(10))))),If(BinaryOp(==,Id(a),Id(b)),CallStmt(Id(io),Id(write),[StringLiteral(\"ABC\")])),Break,Return(Id(a)))))))))))"    
    ...
    def test_simple_program71(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Static,List(VarDecl(Id(length),FloatType),VarDecl(Id(width),FloatType)),VoidType,Block(List(),List(If(BinaryOp(==,Id(a),IntLiteral(1)),CallStmt(Id(io),Id(write),[StringLiteral(\"Suy nua thi\")])),If(BinaryOp(<,Id(b),IntLiteral(0)),AssignStmt(Id(b),BinaryOp(+,Id(c),IntLiteral(3))),AssignStmt(ArrayType(IntLiteral(1),ClassType(b)),FieldAccess(CallExpr(Id(a),Id(get),List()),Id(length)))),AssignStmt(FieldAccess(SelfLiteral(),Id(valid)),Id(a)),Return(Id(temp)))))))))"   
    ...
    def test_simple_program73(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Static,List(VarDecl(Id(length),FloatType),VarDecl(Id(width),FloatType)),VoidType,Block(List(),List(If(BinaryOp(==,Id(a),IntLiteral(1)),CallStmt(Id(io),Id(write),[StringLiteral(\"Suy nua thi\")])),If(BinaryOp(<,Id(b),IntLiteral(0)),AssignStmt(Id(b),BinaryOp(+,Id(c),IntLiteral(3))),AssignStmt(ArrayType(IntLiteral(1),ClassType(b)),Id(a))),For(Id(i),IntLiteral(1),IntLiteral(100),True,Block(List(),List(CallStmt(Id(io),Id(writeIntLn),[Id(i)]),AssignStmt(ArrayType(Id(i),ClassType(Intarray)),BinaryOp(+,Id(i),IntLiteral(1)))))]))))))))"
    ...
    def test_simple_program74(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Static,List(VarDecl(Id(length),FloatType),VarDecl(Id(width),FloatType)),StringType,Block(List(),List(If(BinaryOp(==,Id(a),IntLiteral(1)),CallStmt(Id(io),Id(write),[StringLiteral(\"Suy nua thi\")])),If(BinaryOp(<,Id(b),IntLiteral(0)),Block(List(),List(AssignStmt(Id(b),BinaryOp(+,Id(c),IntLiteral(3))),AssignStmt(Id(c),FieldAccess(CallExpr(Id(Shape),Id(Ten),List()),Id(ten)))))))))))))"
    ...
    def test_simple_program75(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Static,List(VarDecl(Id(length),FloatType),VarDecl(Id(width),FloatType)),VoidType,Block(List(),List(If(BinaryOp(==,Id(a),IntLiteral(1)),CallStmt(Id(io),Id(write),[StringLiteral(\"Suy nua thi\")])),If(BinaryOp(<,Id(b),IntLiteral(0)),AssignStmt(Id(b),BinaryOp(-,BinaryOp(+,CallExpr(Id(c),Id(get),List(StringLiteral(\"Mouse\"))),IntLiteral(3)),CallExpr(Id(c),Id(get),List(StringLiteral(\"Cat\"))))),AssignStmt(ArrayType(IntLiteral(1),ClassType(b)),Id(a))))))))))"    
    ...
    def test_simple_program76(self):
        ...
        expect = "Program(List(ClassDecl(Id(Example2),List(MethodDecl(Id(main),Instance,List(),VoidType,Block(List(AttributeDecl(Instance,VarDecl(Id(s),ClassType(Shape)))),List(AssignStmt(Id(s),NewExpr(Id(Rectangle),List(StringLiteral(\"et\"),IntLiteral(4)))),CallStmt(Id(io),Id(writeFloatLn),[CallExpr(Id(s),Id(getArea),List())]),AssignStmt(Id(s),NewExpr(Id(Triangle),List(IntLiteral(3),IntLiteral(4)))),CallStmt(Id(io),Id(writeFloatLn),[CallExpr(Id(s),Id(getArea),List())]))))))))"
    ...
    def test_simple_program77(self):
        ...
        expect = "Program(List(ClassDecl(Id(Example2),List(MethodDecl(Id(main),Instance,List(),VoidType,Block(List(AttributeDecl(Instance,VarDecl(Id(s),ClassType(Shape)))),List(AssignStmt(Id(s),NewExpr(Id(Rectangle),List(IntLiteral(3),IntLiteral(4),IntLiteral(0)))),CallStmt(Id(io),Id(writeFloatLn),[CallExpr(Id(s),Id(getArea),List())]),AssignStmt(FieldAccess(SelfLiteral(),Id(B)),NewExpr(Id(Triangle),List(IntLiteral(3),IntLiteral(4),StringLiteral(\"TAnv\")))),CallStmt(Id(io),Id(writeFloatLn),[CallExpr(Id(s),Id(getArea),List())]))))))))"
    ...
    def test_simple_program78(self):
        ...
        expect = str(Program([ClassDecl(Id("Example2"),[MethodDecl(Instance(),Id("main"),[],VoidType(),Block([AttributeDecl(Instance(),VarDecl(Id("s"),ClassType("Shape")))],[Assign(Id("s"),NewExpr(Id("Rectangle"),[CallExpr(Id("r"),Id("getVa"),[]),IntLiteral(4)])),CallStmt(Id("io"),Id("writeFloatLn"),[CallExpr(Id("s"),Id("getArea"),[])]),Assign(Id("s"),NewExpr(Id("Triangle"),[IntLiteral(3),IntLiteral(4)])),CallStmt(Id("io"),Id("writeFloatLn"),[CallExpr(Id("s"),Id("getArea"),[])])]))])]))
    ...
    def test_simple_program79(self):
        ...
        expect = "Program(List(ClassDecl(Id(Example2),List(MethodDecl(Id(main),Instance,List(),VoidType,Block(List(AttributeDecl(Instance,VarDecl(Id(s),ClassType(Shape)))),List(AssignStmt(Id(s),NewExpr(Id(Rectangle),List(IntLiteral(3),IntLiteral(4),CallExpr(Id(Mouse),Id(get),List(StringLiteral(\"Anh\")))))),CallStmt(Id(io),Id(writeFloatLn),[CallExpr(Id(s),Id(getArea),List())]),AssignStmt(Id(s),NewExpr(Id(Triangle),List(IntLiteral(3),IntLiteral(4)))),CallStmt(Id(io),Id(writeFloatLn),[CallExpr(Id(s),Id(getArea),List())]))))))))"
    ...
    def test_simple_program80(self):
        ...
        expect = str(Program([ClassDecl(Id("Example2"),[MethodDecl(Instance(),Id("main"),[],VoidType(),Block([AttributeDecl(Instance(),VarDecl(Id("s"),ClassType("Shape")))],[Assign(Id("s"),NewExpr(Id("Rectangle"),[Id("b"),Id("e"),Id("f")])),CallStmt(Id("io"),Id("writeFloatLn"),[CallExpr(Id("s"),Id("getArea"),[])]),Assign(Id("s"),NewExpr(Id("Triangle"),[])),CallStmt(Id("io"),Id("writeFloatLn"),[CallExpr(Id("s"),Id("getArea"),[])])]))])]))
    ...
    def test_simple_program83(self):
        ...
        expect = str(Program([ClassDecl(Id("abc"),[MethodDecl(Static(),Id("getArea"),[VarDecl(Id("length"),FloatType()),VarDecl(Id("width"),FloatType())],VoidType(),Block([AttributeDecl(Instance(),VarDecl(Id("r"),FloatType())),AttributeDecl(Instance(),VarDecl(Id("s"),FloatType())),AttributeDecl(Instance(),VarDecl(Id("a"),ArrayType(IntLiteral(5),StringType()))),AttributeDecl(Instance(),VarDecl(Id("b"),ArrayType(IntLiteral(5),StringType())))],[Assign(Id("r"),FieldAccess(SelfLiteral(),Id("length"))),Assign(Id("s"),BinaryOp("*",BinaryOp("*",Id("r"),Id("r")),FieldAccess(SelfLiteral(),Id("myPI")))),Assign(ArrayType(IntLiteral(0),ClassType("a")),FloatLiteral(2.0))]))])]))    
    ...
    def test_simple_program84(self):
        ...
        expect = "Program(List(ClassDecl(Id(abc),List(MethodDecl(Id(getArea),Static,List(VarDecl(Id(length),FloatType),VarDecl(Id(width),FloatType)),VoidType,Block(List(AttributeDecl(Instance,VarDecl(Id(r),FloatType)),AttributeDecl(Instance,VarDecl(Id(s),FloatType)),AttributeDecl(Instance,VarDecl(Id(a),ArrayType(IntLiteral(5),IntType))),AttributeDecl(Instance,VarDecl(Id(b),ArrayType(IntLiteral(5),IntType)))),List(AssignStmt(Id(r),Id(r)),AssignStmt(Id(s),BinaryOp(*,BinaryOp(*,Id(r),Id(r)),CallExpr(SelfLiteral(),Id(myPI),List(StringLiteral(\"Ne\"),Id(a))))),AssignStmt(ArrayType(IntLiteral(0),ClassType(a)),FloatLiteral(2.0)))))))))"
    ...
    def test_simple_program85(self):
        ...
        expect = str(Program([ClassDecl(Id("abc"),[MethodDecl(Static(),Id("getArea"),[VarDecl(Id("length"),FloatType()),VarDecl(Id("width"),FloatType())],VoidType(),Block([AttributeDecl(Instance(),VarDecl(Id("r"),FloatType())),AttributeDecl(Instance(),VarDecl(Id("s"),FloatType())),AttributeDecl(Instance(),VarDecl(Id("a"),ArrayType(IntLiteral(5),IntType()))),AttributeDecl(Instance(),VarDecl(Id("b"),ArrayType(IntLiteral(5),IntType())))],[Assign(Id("r"),Id("r")),Assign(Id("s"),BinaryOp("*",BinaryOp("*",Id("r"),Id("r")),FieldAccess(SelfLiteral(),Id("myPI")))),Assign(ArrayType(IntLiteral(0),ClassType("a")),FloatLiteral(2.0)),Return(FieldAccess(SelfLiteral(),Id("length")))]))])]))    
    ...
    def test_simple_program87(self):
        ...
        expect = str(Program([ClassDecl(Id("abc"),[MethodDecl(Static(),Id("getArea"),[VarDecl(Id("length"),FloatType()),VarDecl(Id("width"),FloatType())],VoidType(),Block([AttributeDecl(Instance(),VarDecl(Id("r"),FloatType())),AttributeDecl(Instance(),VarDecl(Id("s"),FloatType())),AttributeDecl(Instance(),VarDecl(Id("a"),ArrayType(IntLiteral(5),IntType()))),AttributeDecl(Instance(),VarDecl(Id("b"),ArrayType(IntLiteral(5),IntType())))],[Assign(Id("r"),Id("r")),Assign(Id("s"),BinaryOp("%",BinaryOp("*",BinaryOp("*",Id("r"),Id("r")),FieldAccess(SelfLiteral(),Id("myPI"))),IntLiteral(10))),Assign(ArrayType(IntLiteral(0),ClassType("a")),FloatLiteral(2.0))]))])]))    
    ...
    def test_simple_program90(self):
        ...
        expect = "Program(List(ClassDecl(Id(Shape),List(MethodDecl(Id(getArea),Instance,List(),FloatType,Block(List(),List(AssignStmt(Id(a),StringLiteral(\"b\")))))))))"
    ...
    def test_simple_program95(self):
        input = """class Shape {
                        float getArea(){
                            a := L.A("Neu em con ton tai").name;
                            return -100;
                        }
                    }"""
        expect = "Program(List(ClassDecl(Id(Shape),List(MethodDecl(Id(getArea),Instance,List(),FloatType,Block(List(),List(AssignStmt(Id(a),FieldAccess(CallExpr(Id(L),Id(A),List(StringLiteral(\"Neu em con ton tai\"))),Id(name))),Return(UnaryOp(-,IntLiteral(100))))))))))"
    ...
    def test_simple_program96(self):
        ...
        expect = "Program(List(ClassDecl(Id(Shape),List(MethodDecl(Id(getArea),Instance,List(),FloatType,Block(List(),List(AssignStmt(Id(e),FieldAccess(CallExpr(Id(Ex1),Id(A),List(IntLiteral(1),BinaryOp(-,Id(e),IntLiteral(3)))),Id(name))),Return(UnaryOp(-,IntLiteral(100))))))))))"
    ...
    def test_simple_program97(self):
        ...
        expect = "Program(List(ClassDecl(Id(Shape),List(MethodDecl(Id(getArea),Instance,List(),FloatType,Block(List(),List(AssignStmt(Id(r),CallExpr(CallExpr(Id(Ex1),Id(A),List(BinaryOp(+,Id(r),IntLiteral(5)),StringLiteral(\"chuoi\"))),Id(B),List())),Return(UnaryOp(-,IntLiteral(100))))))))))"
    ...
    def test_simple_program98(self):
        ...
        expect = "Program(List(ClassDecl(Id(Shape),List(MethodDecl(Id(getArea),Instance,List(),FloatType,Block(List(),List(AssignStmt(Id(b),CallExpr(CallExpr(Id(Ex1),Id(A),List()),Id(B),List(StringLiteral(\"theoso\"),Id(t)))),Return(UnaryOp(-,IntLiteral(100))))))))))"
    ...
    def test_simple_program99(self):
        ...
        expect = "Program(List(ClassDecl(Id(Shape),List(MethodDecl(Id(getArea),Instance,List(),FloatType,Block(List(),List(AssignStmt(Id(name),CallExpr(CallExpr(Id(Ex1),Id(A),List(StringLiteral(\"e\"),UnaryOp(-,IntLiteral(2)))),Id(R),List(StringLiteral(\"F\")))),CallStmt(Id(a),Id(print),[StringLiteral(\"Fail\")]),Return(UnaryOp(-,IntLiteral(100))))))))))"
